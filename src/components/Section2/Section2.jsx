                ...
                <Row>
                    ...
                    <Col xl='4' lg='6' md='6'>
                        <div className='Section2__wrapSection'>
                            ...
                            <p className='Section2__subTitle'>
                                Хороший клиентский сервис это рост вашего бизнеса. Онлайн витрина поможет вам получить больше довольных клиентов.
                            </p>
                        </div>
                    </Col>
                    <Col xl='4' lg='6' md='6'>
                        <div className='Section2__wrapSection'>
                            ...
                            <p className='Section2__subTitle'>
                                Вы можете создать совою витрину и начать принимать оплату в течение 5 минут без технических знаний.
                            </p>
                        </div>
                    </Col>
                    <Col xl='4' lg='6' md='6'>
                        <div className='Section2__wrapSection'>
                            ...
                            <p className='Section2__subTitle'>
                                Создание витрины бесплатно, а комиссия снимается только с оплаченного заказа. Мы зарабатываем, когда вы зарабатываете.
                            </p>
                        </div>
                    </Col>
                    <Col xl='4' lg='6' md='6'>
