        ...
        <div className='Section3'>
            <Container>
                ...
                <p className='Section3__subTitle'>
                    Витрина это островок вашего магазина цветов в интернете. Здесь вы можете добавить каталог букетов, принимать оплату онлайн и с легкостью управлять заказами.
                </p>
                <p className='Section3__subTitle'>
